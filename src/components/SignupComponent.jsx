                ...
                >
                    <div class="max-w-xl lg:max-w-3xl">
                        ...
                        <form action="#" class="mt-8 grid grid-cols-6 gap-6">
                            <InputField name="First Name"></InputField>
                            <InputField name="Last Name"></InputField>
                            <InputField name="Email" size=""></InputField>
                            <InputField name="Password"></InputField>
                            <InputField name="Password Confirmation"></InputField>

                            <div class="col-span-6">
                                <p class="text-sm text-gray-500 dark:text-gray-400">
                                    By creating an account, you agree to our
                                    <a href="#" class="text-gray-700 underline dark:text-gray-200 mx-1">
                            ...
                            <div class="col-span-6 sm:flex sm:items-center sm:gap-4">
                                ...
                                <p class="mt-4 text-sm text-gray-500 sm:mt-0 dark:text-gray-400">
                                    ...
                                    <Link to={"/login"} class="text-gray-700 underline dark:text-gray-200 ml-1">Log in</Link>.
                                </p>
                            </div>
                        </form>
                    </div>
